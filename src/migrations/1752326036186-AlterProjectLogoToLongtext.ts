...
export class AlterProjectLogoToLongtext1752326036186 implements MigrationInterface {
    name = 'AlterProjectLogoToLongtext1752326036186'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`projects\` DROP COLUMN \`logo\``);
        await queryRunner.query(`ALTER TABLE \`projects\` ADD \`logo\` longtext NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`projects\` DROP COLUMN \`logo\``);
        await queryRunner.query(`ALTER TABLE \`projects\` ADD \`logo\` varchar(500) COLLATE "utf8mb4_unicode_ci" NULL DEFAULT 'NULL'`);
